...
} from '@/modules/recommendation/application/types/candidates/candidate-source.types';
import type { CatalogProductExclusionOptions } from '@/modules/catalog/application/types/catalog-product.type';
            ...
            .map(([productId, contributions]) => ({
                ...
                contributions: contributions.sort(
                    (left, right) =>
                        ...
                        left.anchorProductId.localeCompare(
                            right.anchorProductId,
                        ),
                ),
            }))
            .sort(
