...
import { RecordInteractionBatchDto } from '@/modules/interactions/presentation/dto/record-interaction-batch.dto';
import { RecordInteractionDto } from '@/modules/interactions/presentation/dto/record-interaction.dto';
...
export class InteractionController {
    ...
    constructor(
        private readonly ingestionService: InteractionIngestionService,
    ) {}
    ...
    async recordInteractionBatch(
        ...
        const result = await this.ingestionService.recordMany(
            dto.events,
            request,
        );
