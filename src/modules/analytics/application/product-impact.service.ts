...
import { ProductImpactRequestDto } from '@/modules/analytics/presentation/dto/product-impact.dto';
import type { ProductImpactResponse } from '@/modules/analytics/application/types/product-impact.types';
import { buildProductImpactItem } from '@/modules/analytics/application/utils/product-impact-calculator';
